...
const Login = () => {
  ...
  return (
    <div>
      ...
      <form className="bg-black opacity-[0.87] absolute w-3/12 p-12 m-36 mx-auto right-0 left-0 text-white">
        ...
        <input
          ...
          className="p-2 m-2 h-[58px] w-[315px] left-[68px] top-5 rounded-b-[3px] rounded-t-[3px]  bg-[#333333] text-[16px]"
        />
        <button className="bg-[#E50914] hover:bg-[#C11119] text-white text-[24px] border-solid rounded-b-[3px] rounded-t-[3px]  h-[58px] w-[315px] mt-[30px] ml-[11px]">
          Sign In
        </button>
